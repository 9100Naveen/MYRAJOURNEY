// generate-summary.js
// Generates an Excel summary of the 300 Appium login test cases
...
async function createExcelReport() {
  ...
  console.log('Appium test summary Excel written to', outputPath);
}

createExcelReport().catch(err => console.error('Error generating Excel:', err));
