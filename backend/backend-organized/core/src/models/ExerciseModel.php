...
class ExerciseModel
{
    ...
    public function getAllExercises()
    {
        ...
        try {
            ...
            // Table might not exist yet, allow fallback to kick in
            $exercises = [];
        }
        
        // Comprehensive fallback if DB is empty to support frontend display
        if (empty($exercises)) {
            $names = [
            ...
            foreach ($names as $index => $name) {
                $exercises[] = [
                    'id' => 1000 + $index,
                    'name' => $name,
                    'description' => 'Perform ' . $name . ' as prescribed.',
                    'category' => 'REHAB',
                    'target_joints' => [],
                    ...
                    'animation_url' => null,
                    'instructions' => [],
                    'ra_benefits' => ['Improves mobility and reduces stiffness'],
