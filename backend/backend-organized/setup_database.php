 ...
 * This script initializes the 'myrajourney' database and all required tables.
 */

// 1. Initial Connection to MySQL (w/o database selected)
$host = '127.0.0.1';
$user = 'root';
$pass = '';
$dbName = 'myrajourney';
...
try {
    $pdo = new PDO("mysql:host=$host;port=3308", $user, $pass, [
    ...
    $tables = [
        ...
        "patient_medications" => "CREATE TABLE IF NOT EXISTS patient_medications (
            id INT AUTO_INCREMENT PRIMARY KEY,
            patient_id INT NOT NULL,
            medication_id INT,
            doctor_id INT,
        ...
        "rehab_plans" => "CREATE TABLE IF NOT EXISTS rehab_plans (
            id INT AUTO_INCREMENT PRIMARY KEY,
            patient_id INT NOT NULL,
            title VARCHAR(255) NOT NULL,
            description TEXT,
        ...
        "rehab_exercises" => "CREATE TABLE IF NOT EXISTS rehab_exercises (
            id INT AUTO_INCREMENT PRIMARY KEY,
        ...
        "ra_exercises" => "CREATE TABLE IF NOT EXISTS ra_exercises (
            id INT AUTO_INCREMENT PRIMARY KEY,
            name VARCHAR(255) NOT NULL,
            description TEXT,
            category VARCHAR(100),
        ...
        "exercise_assignments" => "CREATE TABLE IF NOT EXISTS exercise_assignments (
        ...
        "exercise_sessions" => "CREATE TABLE IF NOT EXISTS exercise_sessions (
            id VARCHAR(50) PRIMARY KEY,
            patient_id INT NOT NULL,
        ...
        "performance_reports" => "CREATE TABLE IF NOT EXISTS performance_reports (
            id VARCHAR(50) PRIMARY KEY,
        ...
        "symptom_logs" => "CREATE TABLE IF NOT EXISTS symptom_logs (
            id INT AUTO_INCREMENT PRIMARY KEY,
            patient_id INT NOT NULL,
            date DATE NOT NULL,
            pain_level INT,
    ...
    foreach ($tables as $name => $sql) {
        $pdo->exec($sql);
        echo "✓ Table `$name` created or validated.<br>";
    }
    
    echo "<br>🚀 <b>Setup Complete!</b> Your MyRA Journey database is ready.<br>";
    echo "<a href='index.php/api/v1/auth/register'>Click here to verify API access</a>";
